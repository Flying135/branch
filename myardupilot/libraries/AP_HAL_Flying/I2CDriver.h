...
#ifndef __AP_HAL_Flying_I2CDRIVER_H__
#define __AP_HAL_Flying_I2CDRIVER_H__

#include <AP_HAL_Flying.h>

class Flying::FlyingI2CDriver : public AP_HAL::I2CDriver {
public:
    FlyingI2CDriver(I2C_TypeDef* i2c, GPIO_TypeDef* port,
...
#define FlyingI2CDriverInstance(I2Cx, semaphore)                            	\
FlyingI2CDriver I2Cx##Driver((I2C_TypeDef*) I2Cx, (GPIO_TypeDef*) I2Cx##_PORT,	\
							 I2Cx##_CLK, I2Cx##_GPIOCLK,						\
							 I2Cx##_SCL_BIT, I2Cx##_SDA_BIT,					\
							 I2Cx##_SCL_PINSOURCE, I2Cx##_SDA_PINSOURCE,		\
							 semaphore)

#endif // __AP_HAL_Flying_I2CDRIVER_H__

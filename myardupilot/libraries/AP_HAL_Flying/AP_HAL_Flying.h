...
#ifndef __AP_HAL_Flying_H__
#define __AP_HAL_Flying_H__

/* Your layer exports should depend on AP_HAL.h ONLY. */
#include <AP_HAL.h>

/**
 * Umbrella header for AP_HAL_Flying module.
 ...
 * names, headers) via the Flying namespace.
 * The class implementing AP_HAL::HAL should be called HAL_Flying and exist
 * in the global namespace. There should be a single const instance of the
 * HAL_Flying class called AP_HAL_Flying, instantiated in the HAL_Flying_Class.cpp
 * and exported as `extern const HAL_Flying AP_HAL_Flying;` in HAL_Flying_Class.h
 *
 * All declaration and compilation should be guarded by CONFIG_HAL_BOARD macros.
 * In this case, we're using CONFIG_HAL_BOARD == HAL_BOARD_Flying.
...
#include "HAL_Flying_Class.h"
#include "AP_HAL_Flying_Main.h"

#endif // CONFIG_HAL_BOARD

#endif //__AP_HAL_Flying_H__
